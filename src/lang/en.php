...
"user-was-online-notification" => "[user]%1[/user] was online from %2 to %3",
...
"banlist-head" => "Banlist:",
"banlist-user-entry" => "%1 (reason: \"%2\", banned till: %3)",
"banlist-no-banned-users-text" => "No banned users!",
