...
class SiPacProxy_bbcode extends SiPacProxy
{
	...
	{  
		...
		$this->post['message'] = preg_replace('-\[img\](https?://.*?\.(?:jpg|jpeg|png|gif|bmp|tif|svg))\[/img\]-i','<a href="$1" target="_blank"><img src="$1" alt="$1" style="max-width: 100%;  max-height: 300px;"></img></a>', $this->post['message']);
